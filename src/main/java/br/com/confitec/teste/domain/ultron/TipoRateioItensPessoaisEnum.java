...
@Getter
@AllArgsConstructor
public enum TipoRateioItensPessoaisEnum implements ConfiguracaoRateio {
	...
	IOF(ComposicaoFaturamentoConstants.IOF, TipoRateioEnum.CONVENCIONAL_PRIMEIRA_PARCELA_IOF),
	...
	public static TipoRateioEnum getTipoRateio(final String tipoComposicaoPremio) {
		for (final TipoRateioItensPessoaisEnum tipoRateioPremio : values())
